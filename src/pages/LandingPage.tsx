...
export default function LandingPage() {
  ...
  return (
    <main className="landing-page min-h-screen relative" style={{ scrollBehavior: "smooth" }}>
      ...
      {/* ─── Floating Navbar ─── */}
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? "lp-navbar-scrolled" : "bg-transparent"}`}
      >
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Link to="/auth">
              <Button variant="ghost" size="sm" className="text-sm" style={{ color: "hsl(240 5% 65%)" }}>
                Connexion
              </Button>
            </Link>
            <Link to="/auth?tab=register">
              <Button
                size="sm"
                className="lp-glow-btn rounded-full px-5 text-sm font-medium"
                style={{ background: "linear-gradient(135deg, hsl(217 91% 55%), hsl(217 91% 45%))", color: "white" }}
              >
                Créer un compte
              </Button>
            </Link>
        ...
        {menuOpen && (
          <motion.div
            ...
            className="lp-glass px-4 pb-4 pt-2 md:hidden"
          >
            <div className="flex flex-col gap-3">
              ...
              <Link to="/auth" onClick={() => setMenuOpen(false)}>
                <Button variant="ghost" className="w-full justify-start" style={{ color: "hsl(240 5% 65%)" }}>
                  Connexion
                </Button>
              </Link>
      ...
      <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
        ...
        >
          <motion.div variants={fadeUp}>
            <Badge
              className="mb-6 rounded-full px-4 py-1.5 text-xs font-medium border"
              style={{
                background: "hsla(217, 91%, 60%, 0.1)",
                borderColor: "hsla(217, 91%, 60%, 0.2)",
                color: "hsl(217 91% 70%)",
              }}
            >
          ...
          <motion.h1
            variants={fadeUp}
            className="text-4xl font-extrabold sm:text-5xl lg:text-7xl"
          ...
          <motion.div variants={fadeUp} className="mt-16 sm:mt-20">
            <motion.div
              ...
              className="lp-dashboard-mockup mx-auto max-w-4xl overflow-hidden"
            >
              <div
              ...
              <div className="p-4 sm:p-6">
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
                  {[
                    ...
                    >
                      <div className="text-xs mb-1" style={{ color: "hsl(240 5% 45%)" }}>
                        {s.label}
                      </div>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <div
                    className="col-span-2 rounded-lg h-32"
                    style={{ background: "hsla(0, 0%, 100%, 0.02)", border: "1px solid hsla(0, 0%, 100%, 0.04)" }}
                  >
                    <div className="p-3">
                      <div className="text-xs mb-3" style={{ color: "hsl(240 5% 45%)" }}>
                      ...
                      <div className="flex items-end gap-1.5 h-16">
                        {[40, 65, 45, 80, 55, 90, 70].map((h, i) => (
                          <div
                            ...
                            style={{ height: `${h}%`, background: `hsla(217, 91%, 60%, ${0.3 + i * 0.1})` }}
                          />
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="p-3">
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={b.l}>
                            <div className="text-[10px] mb-0.5" style={{ color: "hsl(240 5% 40%)" }}>
                              {b.l}
                            </div>
                            <div
      ...
      <section
        ...
        style={{ borderTop: "1px solid hsla(0, 0%, 100%, 0.05)", borderBottom: "1px solid hsla(0, 0%, 100%, 0.05)" }}
      >
        <motion.div
        ...
        >
          {stats.map((s) => (
            <motion.div key={s.label} variants={fadeUp} className="text-center">
              ...
              <div className="mt-1 text-xs sm:text-sm" style={{ color: "hsl(240 5% 45%)" }}>
                {s.label}
              </div>
            </motion.div>
          ))}
      ...
      <section id="features" className="relative z-10 py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          >
            ...
            <h2
              className="text-3xl font-bold sm:text-4xl lg:text-5xl lp-gradient-text"
          ...
          >
            {features.map((f) => (
              <motion.div
                key={f.title}
                variants={scaleIn}
                className={`lp-glass-card lp-bento-card rounded-xl p-6 ${f.span}`}
              >
                <div
            ...
            {[
              ...
              <motion.div key={item.title} variants={fadeUp} className="flex gap-4 items-start">
                <div
                  ...
                  style={{ background: "hsla(217, 91%, 60%, 0.08)" }}
                >
                  <item.icon className="h-5 w-5" style={{ color: "hsl(217 91% 65%)" }} />
                </div>
                <div>
                  <h3 className="font-semibold" style={{ color: "hsl(0 0% 95%)" }}>
                    {item.title}
                  </h3>
          ...
          >
            {displayPlans.map((plan) => (
              <motion.div key={plan.id} variants={scaleIn}>
                <div
                  className={`lp-glass-card rounded-2xl p-6 sm:p-8 flex flex-col h-full relative ${plan.highlight ? "lp-pricing-popular" : ""}`}
                >
                  {plan.highlight && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <Badge
                        className="rounded-full px-4 py-1 text-xs font-medium shadow-lg"
                        style={{
                          background: "linear-gradient(135deg, hsl(217 91% 55%), hsl(187 72% 50%))",
                          color: "white",
                          border: "none",
                        }}
                      >
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold mb-1" style={{ color: "hsl(0 0% 95%)" }}>
                      {plan.name}
                    </h3>
                    ...
                    <div className="mt-4">
                      ...
                      {plan.period && (
                        <span className="text-sm ml-1" style={{ color: "hsl(240 5% 45%)" }}>
                          {plan.period}
                        </span>
                      )}
                    </div>
                      ...
                      <Button
                        ...
                        style={{
                          background: plan.highlight
                            ? "linear-gradient(135deg, hsl(217 91% 55%), hsl(217 91% 40%))"
                            : "hsla(0, 0%, 100%, 0.06)",
                          color: plan.highlight ? "white" : "hsl(0 0% 90%)",
                          border: plan.highlight ? "none" : "1px solid hsla(0, 0%, 100%, 0.1)",
                        }}
                      >
      ...
      <section className="relative z-10 py-20 sm:py-28">
        ...
        >
          <motion.h2
            variants={fadeUp}
            className="text-3xl font-bold sm:text-4xl lp-gradient-text"
            style={{ letterSpacing: "-0.02em" }}
          >
