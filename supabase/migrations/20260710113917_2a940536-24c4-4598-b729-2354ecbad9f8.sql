CREATE OR REPLACE FUNCTION public.detect_health_issues(slow_threshold_s numeric DEFAULT 5, bloat_ratio numeric DEFAULT 30, min_size_mb numeric DEFAULT 50)
 RETURNS jsonb
 LANGUAGE plpgsql
...
BEGIN
  ...
  FROM (
    ...
    WHERE a.datname = current_database()
      ...
      -- Only real client/application queries. Exclude replication (walsender),
      -- autovacuum, and other background backends that stay "active" by design.
